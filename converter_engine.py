    ...
    def _parse_cv_to_json(self, source_text: str, *, qcv_generated: bool = False) -> dict:
        ...
        if qcv_generated:
            qcv_hint = (
                ...
                "- Do NOT infer technologies from project descriptions and add them to Environment.\n"
                "- Do NOT add SQL, JWT, REST, or any other 'obvious' technologies unless they are explicitly listed.\n"
                "- Do NOT merge or split any text lines.\n"
                "- Do NOT fix dates or reorder anything.\n"
                "- If a field is empty in the source, it MUST be empty in the output.\n"
                "- ANY deviation from the source text is a critical error.**\n"
            )
        full_prompt = (
